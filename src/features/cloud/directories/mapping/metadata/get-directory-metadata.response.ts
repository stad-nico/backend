...
import { DirectoryMetadata } from 'src/db/repositories/directory.repository';
...
export class GetDirectoryMetadataResponse {
	...
	public static fromMetadata(metadata: DirectoryMetadata): GetDirectoryMetadataResponse {
