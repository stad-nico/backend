...
import { DirectoryJob, DirectoryQueue } from 'src/queues/directory.queue';
...
export class FileService {
	public constructor(
		...
		private readonly directoryQueue: DirectoryQueue
	) {}
	...
	public async upload(uploadFileDto: UploadFileDto): Promise<UploadFileResponse> {
		...
		await this.directoryQueue.addJob(DirectoryJob.UpdatedAt, { id: directory.id, updatedAt: new Date() });
